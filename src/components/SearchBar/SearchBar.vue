    ...
    <div class="flex space-x-5 mb-2 w-full md:w-max">
        <div class="w-full">
            <div class="mt-1 flex rounded-md shadow-sm">
                <Input
                    class="block w-full sm:text-sm border-gray-300 dark:border-dark-200 dark:bg-dark-600 dark:text-white dark:placeholder:text-dark-500"
                    :input-class="{
                ...
                <select
                    ...
                    id="typeSearch"
                    name="typeSearch"
                    class="-ml-px relative inline-flex items-center space-x-2 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary dark:border-dark-200 dark:bg-dark-600 dark:text-white"
                    @change="filter"
                    v-model="searchKey"
        ...
        <template v-if="enumOptions">
            <div class="flex flex-col">
                ...
                <select
                    id="enumKey"
                    name="enumKey"
                    class="mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:border-primary focus:outline-none focus:ring-primary sm:text-sm dark:border-dark-200 dark:bg-dark-600 dark:text-white"
                    v-model="enumKey"
                    @change="filter"
                >
